...
async function sendBookingEmails({ 
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f0f4f3;padding:0;margin:0;">
        ...
        <td align="center" style="padding:40px 16px;">
            ...
            <tr>
                <td style="padding:0 40px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e2e8e7;border-radius:10px;overflow:hidden;">
                    <!-- Row: Full Name -->
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;width:140px;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">Full Name</span>
                    </td>
                    ...
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">Email</span>
                    </td>
                    <td style="padding:12px 16px;border-bottom:1px solid #e2e8e7;">
                    ...
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">WhatsApp Number</span>
                    </td>
                    <td style="padding:12px 16px;border-bottom:1px solid #e2e8e7;">
                    ...
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">Date</span>
                    </td>
                    <td style="padding:12px 16px;border-bottom:1px solid #e2e8e7;">
                    ...
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">Time</span>
                    </td>
                    <td style="padding:12px 16px;border-bottom:1px solid #e2e8e7;">
                    ...
                    <!-- Row: Duration -->
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;padding: 5px 0 5px 0;border-bottom:1px solid #e2e8e7;">
                    ...
                    <tr>
                    <td style="padding:12px 16px;background-color:#f7fafa;border-bottom:1px solid #e2e8e7;">
                        <span style="font-size:12px;text-transform:uppercase;padding: 5px 0 5px 0;letter-spacing:0.8px;color:#0d9488;font-weight:700;">Referral Source</span>
                    </td>
                    <td style="padding:12px 16px;border-bottom:1px solid #e2e8e7;">
            ...
            <tr>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                    <td align="center" style="border-radius:6px;background-color:#1a1a1a;">
                        <a href="${meetLink}" target="_blank" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:6px;background-color:#1a1a1a;">Join with Google Meet</a>
                    </td>
                    </tr>
                </table>
                </td>
